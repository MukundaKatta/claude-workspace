...
| | Count |
|---|---|
| Total public repos | 661 |
| Original (non-fork) | 223 |
| Active (non-fork, non-archived) | 185 |
| Forks | 438 |
| Archived | 318 |
...
A curated cut of the 185 active originals, sorted by theme. The full list lives in [`data/repos.ndjson`](data/repos.ndjson) and is regenerated by `scripts/refresh.sh`.
