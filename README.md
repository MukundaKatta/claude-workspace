...
| | Count |
|---|---|
| Total public repos | 840 |
| Original (non-fork) | 326 |
| Active (non-fork, non-archived) | 288 |
| Forks | 514 |
| Archived | 306 |
...
A curated cut of the 288 active originals, sorted by theme. The full list lives in [`data/repos.ndjson`](data/repos.ndjson) and is regenerated by `scripts/refresh.sh`.
...
Archived originals and forks are indexed in [`data/repos.ndjson`](data/repos.ndjson) (one JSON record per line, 840 records total). Refresh with:
